...
const kpis: {
...
}[] = [
  {
    ...
    iconBg: "bg-gradient-to-br from-blue-500/15 to-blue-600/10 text-blue-600",
  ...
  },
  {
    ...
    iconBg: "bg-gradient-to-br from-emerald-500/15 to-emerald-600/10 text-emerald-600",
  ...
  },
  {
    ...
    iconBg: "bg-gradient-to-br from-amber-500/15 to-orange-500/10 text-amber-600",
  ...
  },
  {
    ...
    iconBg: "bg-gradient-to-br from-violet-500/15 to-purple-600/10 text-violet-600",
